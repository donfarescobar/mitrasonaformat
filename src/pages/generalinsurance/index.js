          ...
          <div className="px-4 py-10 md:px-8 lg:px-12 xl:px-24 lg:py-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="flex flex-col flex-start gap-3 md:gap-6">
                ...
                <div className="flex flex-col gap-2.5 lg:gap-3.5">
                    <h3 className="product-card-header text-xl lg:text-2xl">
                      {GENERAL_INSURANCE.component1.title}
                    </h3>
                    <p className="engineering-page-card-description text-sm md:text-base">
                      {GENERAL_INSURANCE.component1.description}
                    </p>
                    <div>
                      <Link to="/Engineering"
              ...
              <div className="flex flex-col flex-start gap-3 md:gap-6">
                ...
                <div className="flex flex-col gap-2.5 lg:gap-3.5">
                    <h3 className="product-card-header text-xl lg:text-2xl">
                      {GENERAL_INSURANCE.component2.title}
                    </h3>
                    <p className="engineering-page-card-description text-sm md:text-base">
                      {GENERAL_INSURANCE.component1.description}
                    </p>
              ...
              <div className="flex flex-col flex-start gap-3 md:gap-6">
                ...
                <div className="flex flex-col gap-2.5 lg:gap-3.5">
                    <h3 className="product-card-header text-xl lg:text-2xl">
                      {GENERAL_INSURANCE.component3.title}
                    </h3>
                    <p className="engineering-page-card-description text-sm md:text-base">
                      {GENERAL_INSURANCE.component1.description}
                    </p>
              ...
              <div className="flex flex-col flex-start gap-3 md:gap-6">
                ...
                <div className="flex flex-col gap-2.5 lg:gap-3.5">
                    <h3 className="product-card-header text-xl lg:text-2xl">
                      {GENERAL_INSURANCE.component4.title}
                    </h3>
                    <p className="engineering-page-card-description text-sm md:text-base">
                      {GENERAL_INSURANCE.component1.description}
                    </p>
              ...
              <div className="flex flex-col flex-start gap-3 md:gap-6">
                ...
                <div className="flex flex-col gap-2.5 lg:gap-3.5">
                    <h3 className="product-card-header text-xl lg:text-2xl">
                      {GENERAL_INSURANCE.component5.title}
                    </h3>
                    <p className="engineering-page-card-description text-sm md:text-base">
                      {GENERAL_INSURANCE.component1.description}
                    </p>
              ...
              <div className="flex flex-col flex-start gap-3 md:gap-6">
                ...
                <div className="flex flex-col gap-2.5 lg:gap-3.5">
                    <h3 className="product-card-header text-xl lg:text-2xl">
                      {GENERAL_INSURANCE.component6.title}
                    </h3>
                    <p className="engineering-page-card-description text-sm md:text-base">
                    {GENERAL_INSURANCE.component1.description}
                    </p>
